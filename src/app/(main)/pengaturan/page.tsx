...
import { removeDeviceFromUser, removeUserFromSharedWith, updateDocument, useSharedUsers } from "@/lib/firebase";
import { SensorConfig } from "@/model/Device";
...
export default function PengaturanPage() {
  ...
  }, [devices, activeTab, selectedDevice, visibleDevices, ownedDevices, sharedDevices, setActiveTab, setSelectedDevice]);
  ...
  return (
    <>
          ...
          <div className='grid grid-cols-2 gap-4 max-w-fit'>
            <div className="bg-white/40 border border-white/60 rounded-lg lg:rounded-2xl rounded-b-none px-3 py-3 lg:px-6 lg:py-4 w-full max-w-[320px]">
              <div className="flex flex-col gap-1 mb-3">
                ...
                <p className='text-sm text-foreground/80'>TDS Offset Voltage</p>
              </div>
              <div className="flex items-center gap-2">
      ...
      {/* BAGIKAN AKSES */}
      <div>
        <div className={`${isOwner ? "flex" : "hidden"} flat-glass-container rounded-t-2xl lg:rounded-4xl flex-col items-start gap-4 px-4 lg:px-8 pt-3 lg:pt-6 pb-6`}>
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <div className="hidden lg:flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent sideOffset={5} className='flex flex-col gap-1' align='end'>
                    <p>Bagikan data ke pengguna lain</p>
                    <p>yang menambahkan perangkat Anda</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            </div>
